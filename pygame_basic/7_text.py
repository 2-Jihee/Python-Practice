...
# 화면 타이틀 설정
pygame.display.set_caption("Jihee Game")  # 게임이름

# FPS
clock = pygame.time.Clock()

# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/USER/Desktop/Git-PythonWorkspace/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/USER/Desktop/Git-PythonWorkspace/pygame_basic/character.png")
...
character_y_pos = screen_hight - character_hight # 화면 세로 크기 가장 아래에 해당하는 곳에 위치 (세로 위치)
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/USER/Desktop/Git-PythonWorkspace/pygame_basic/enemy.png")
